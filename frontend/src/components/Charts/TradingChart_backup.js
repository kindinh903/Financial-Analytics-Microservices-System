...
//   // Fetch initial data from API and then switch to WebSocket
...
//       // First, get historical data from API to populate the chart
...
//     console.log(`🔌 Connecting to WebSocket for ${chartConfig.symbol} - ${chartConfig.timeframe}`);

//     // Connect to candle stream for real-time candle updates
//     websocketService.connectCandle(
//       chartConfig.symbol,
...
//     // Also connect to price stream for real-time price updates
...
//   // Handle WebSocket candle messages
...
//   // Handle WebSocket price messages (for current price display)
...
//     console.log(`🔌 WebSocket closed for ${chartConfig.symbol}:`, event);
//     setIsConnected(false);
//   }, [chartConfig.symbol]);

//   // Disconnect WebSocket when component unmounts or symbol changes
//   const disconnectWebSocket = useCallback(() => {
//     if (chartConfig.symbol) {
//       websocketService.disconnect(`candle_${chartConfig.symbol}_${chartConfig.timeframe}`);
//       websocketService.disconnect(`price_${chartConfig.symbol}`);
//       setIsConnected(false);
//     }
//   }, [chartConfig.symbol, chartConfig.timeframe]);
...
//   useEffect(() => {
//     if (isReady) {
//       disconnectWebSocket(); // Disconnect previous connections
//       initializeData(); // Initialize with historical data and connect WebSocket
//     }
...
//       disconnectWebSocket();
//     };
//   }, [isReady, chartConfig.symbol, chartConfig.timeframe, initializeData, disconnectWebSocket]);
